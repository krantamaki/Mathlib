...
namespace lalib {
  ...
  public:
     ...
     *
     * Frees the allocated memory, when object goes out of scope.
     */
    ~DenseMatrix();
     ...
     * @return A boolean signifying false if equal and true if unequal 
     */
    bool isclose(const DenseMatrix& that, double tol = 0.000001);
    ...
    /**
     * @brief Convert DenseMatrix into a double
     *
