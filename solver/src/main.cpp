...
/*
  Compile at root mathlib with: g++ -std=c++17 -mavx -fopenmp -Wall solver/src/main.cpp solver/src/parse_file.cpp solver/src/linearSolver.cpp lalib/src/crs/crsMatrix.cpp lalib/src/crs/crsVector.cpp lalib/src/crs/crsMatmul.cpp -lm -o solver.o
...
int main(int argc, char* argv[]) {
  ...
  solver::linearSolver(config_map["coef_path"], config_map["rhs_path"], config_map["ret_path"],
